...
export const portfolioData: PortfolioData = {
  meta: {
    ...
    description: "Personal portfolio of Terry Nguyen, Full Stack Software Engineer specializing in scalable web systems, cloud infrastructure, and AI engineering.",
  },
  navigation: [
  ...
  hero: {
    ...
    socialLinks: [
      ...
      { label: "LinkedIn", href: "https://linkedin.com/in/terrykn", isPrimary: false },
      { label: "Email", href: "mailto:terryknguyen@gmail.com", isPrimary: false },
    ],
  },
  skills: [
    {
      category: "Languages",
      skills: ["Java", "Python", "TypeScript", "JavaScript", "SQL", "HTML/CSS", "YAML"],
    },
    {
      category: "Frameworks & Libraries",
      skills: ["React", "Spring Boot", "Node.js", "Flask", "FastAPI", "JUnit", "LangGraph", "React Native"],
    },
    {
      category: "Databases & Storage",
      skills: ["PostgreSQL", "MySQL", "MongoDB", "Redis", "SQLite", "MariaDB", "Firebase Firestore"],
    },
    {
      category: "Tools, Cloud & DevOps",
      skills: ["Git", "GitLab CI/CD", "Docker", "Kubernetes", "Red Hat OpenShift", "Ansible", "Grafana"],
    },
  ],
  experience: [
    {
      ...
      technologies: ["React", "TypeScript", "Python", "Flask", "LangGraph", "Claude API", "Ansible", "OpenShift", "Kubernetes", "GitLab CI/CD", "MongoDB", "MariaDB"],
    },
    {
      ...
      technologies: ["Python", "Flask", "Ansible", "Grafana", "Red Hat Enterprise Linux"],
    },
    {
      ...
      technologies: ["React", "TypeScript", "Java", "Spring Boot", "Python", "React Native", "Prompt Engineering", "LLM Evaluation"],
    },
    {
      ...
      technologies: ["Customer Support", "Technical Support", "Event Management"],
    },
    {
    ...
    },
    {
      ...
      technologies: ["Environmental Research", "Data Collection", "Field Analysis"],
    },
    {
    ...
    },
    {
      ...
      technologies: ["Qualitative Analysis", "Research Methodology", "Educational Psychology"],
    },
  ],
  projects: [
    {
      ...
      tags: ["Java", "Spring Boot", "React", "TypeScript", "PostgreSQL", "Docker", "REST API"],
    ...
    },
    {
      ...
      title: "Portfolio",
      date: "Sep 2026",
      description: "Personal portfolio featuring my projects and experience. Designed with customized components from React Bits, Be UI, Animata, and Aceternity.",
    ...
    },
    {
      ...
      tags: ["React", "Next.js 15", "shadcn/ui", "Tailwind CSS", "Framer Motion"],
      demoUrl: "https://lumina-landing-template.vercel.app",
      demoLabel: "Live Demo",
      sourceUrl: "https://github.com/terrykn/lumina-mobile-app-landing-template",
      sourceLabel: "GitHub",
    },
    {
      id: "proj-agenda",
    ...
    },
    {
      ...
      tags: ["React Native", "JavaScript", "Python", "FastAPI", "Expo", "Cloudflare AI"],
  ...
  footer: {
    ...
    links: [
      { label: "LinkedIn", href: "https://linkedin.com/in/terrykn" },
      { label: "Email", href: "mailto:terryknguyen@gmail.com" },
    ],
  },
};