      ...
      <div className="flex min-h-0 flex-col gap-y-8 w-full">
        <div className="flex flex-col gap-y-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Hackathon highlights</h2>
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              During my time at Rutgers, I enjoyed attending various hackathons, where people would come together to build incredible projects in just 1-2 days. I had the opportunity to meet many students and collaborate on some of my favorite projects.
            </p>
          </div>
        </div>
        <Timeline>
